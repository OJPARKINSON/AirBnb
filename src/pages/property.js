...
const Property = (props) => {
    ...
    }, [props.match.params.id, props.match.params.property])
    return (
        <div>
            ...
            <div>
                ...
                <br />
                <NewStays owner={property.user_id} property={props.match.params.property} user={props.match.params.user} bedrooms={property.bedrooms} price={property.nightlyCost} houseName={property.houseName}/>
            </div>
            ) : "loading"}
        </div>
    )
